...
class VrettasFung(HydrologicalModel):
    ...
    1) Vrettas, M. D., and I. Y. Fung (2015), "Toward a new parameterization of
    ...
    2) Vrettas, M. D., and I. Y. Fung (2017), "Sensitivity of transpiration to
    subsurface properties: Exploration with a 1-D model", Journal of Advances in
    Modelling Earth Systems, 9, doi:10.1002/2016MS000901.
    """
